...
module.exports = {
  ...
  getAllQuestions: function(req, res, next) {
    ...
    // these are arrays... do we even need value?

    var questions = [{
        questionText: "How do you want to change testprofile1?",
        answers: [{label: "add 10 to attribute1", value: 0, effects: [10], categories: ["attribute1"]},
        {label: "subtract 10 from attribute1", value: 1, effects: [-10], categories: ["attribute1"]},
